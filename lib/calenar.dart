  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,  // Align everything in the center
            children: [
              SizedBox(
                height: 500,
                width: 400,
              ...
              Spacer(flex: 3), // Larger spacer to push buttons higher
              ElevatedButton(
              ...
              Spacer(flex: 1), // Smaller spacer to add space at the bottom
            ],
          ),
        ),
      ),
